...
/**
   ...
   @version 1.06 2000 Mar 24-26, 30; Apr 26, 28; 2001 Feb 5-7;
   Oct 1; Nov 20, 23; 2004 Jan 20, 29; 2010 Aug
 */
...
   /**
    ...
    */
   public HashMap<String, ArrayList<ASDGrammarNode>> getGrammar()
      throws IOException, ASDInputException
   {  HashMap<String, ArrayList<ASDGrammarNode>> result
         = new HashMap<String, ArrayList<ASDGrammarNode>>(DEFAULT_CAPACITY);
      ASDWordEntry wordEntry;
      while(true)
      {  wordEntry = getWordEntry();
         if (wordEntry == null) break;
         result.put(wordEntry.getWord(),
                    wordEntry.getInstances());
      }
      reader.close();
      return result;
   } // end getGrammar
...
      else
      {  successorTypes = new ArrayList<String>();
         if (currentToken.equalsIgnoreCase("nil") ||
             currentToken.equalsIgnoreCase("null"))
