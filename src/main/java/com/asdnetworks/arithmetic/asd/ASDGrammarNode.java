...
/**
   ...
   @version 1.06 2000 Mar-Apr; 2001 Feb, Oct, Nov; 2003 Jul
    2004 Aug (minor comment fix); 2005 Oct; 2010 Aug
 */
public class ASDGrammarNode
{
   ...
   public ASDGrammarNode(String word, String instance,
      boolean begins, ArrayList<String> beginsTypes,
      ArrayList<ASDGrammarSuccessor> successors,
      ArrayList<String> successorTypes,
...
   /**
    ...
    */
   public ArrayList<ASDGrammarSuccessor> successors() { return nodeSuccessors; }
    ...
    */
   public ArrayList<String> successorTypes() { return nodeSuccessorTypes; }
