...
   /*
   ...
   {  stringToBeParsed = aString;
      backstack = new Stack<ASDParseState>();
...
   /**
    ...
    */
    ArrayList<ASDParseChoice> initialsForTypes(String aWord,
                                               ArrayList<String> expected)
    {  ArrayList<ASDParseChoice> result = new ArrayList<ASDParseChoice>(5);
       ArrayList<ASDGrammarNode> wordEntry = ASDLexicon.lookupWord(aWord);
...
{  public ASDSubphraseStackFrame(int begin, HashMap<String, Object> feat,
                                 boolean uniq)
   {  beginning = begin;
      features = feat;
      unique = uniq;
